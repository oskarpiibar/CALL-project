...
# Load the three CSV files and keep only the 'text' and 'correct' columns, dropping duplicates
...
df3 = pd.read_csv('../POS sequences/sequence_extracted_texts_Russian_4.csv')[['text', 'correct']].drop_duplicates()
...
df6 = pd.read_csv('../POS sequences/sequence_extracted_texts_Spanish_4.csv')[['text', 'correct']].drop_duplicates()
...
df9 = pd.read_csv('../POS sequences/sequence_extracted_texts_Chinese (Mandarin)_4.csv')[['text', 'correct']].drop_duplicates() """
